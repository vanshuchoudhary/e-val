...
const FormComponent = () => {
  ...
  return (
    <div className="form-container">
      <h1 className="heading">Revolutionizing Nutrition Awareness</h1>
      <h6>Please, write product name or you can upload an ingredients list image to generate your product score</h6>
